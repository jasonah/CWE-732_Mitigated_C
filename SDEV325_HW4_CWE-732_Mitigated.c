 ...
 * JASON HOWARTH
 * SDEV325 6380
 * HOMEWORK 4 - MITIGATED CWE-732: Incorrect Permission Assignment for Critical Resource
 * 02 JULY 2017
 * SDEV325_HW4_CWE-732_Mitigated.c
 */
...
int main(int argc, char** argv) {
    ...
    //MITIGATED CWE-732
    //umask(0077) sets permissions allowing only the user to read/write the created file.
    umask(0077);
